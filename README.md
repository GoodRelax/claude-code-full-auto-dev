...
Phase 0 で AI が CLAUDE.md を提案・配置した後、Phase 1 でユーザーへの構造化ヒアリングを実施し、srs-writer エージェントが `user-order.md` + ヒアリング結果 + `anms-template/` を基に仕様書を `docs/spec/` に生成し、以降のフェーズが自動で進行します。
