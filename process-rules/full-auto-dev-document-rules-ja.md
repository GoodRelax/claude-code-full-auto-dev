...
| 総括レポート | `final-report.md` | シングルトン。Phase 5で作成 |
...
| change-request | 変更を要求したエージェント | change-manager, lead, ユーザー | change-manager |
...
| security-reviewer | sast-report等 | スキャン結果の完全制御 |
...
CLAUDE.md に以下を設定する（Phase 0 で AI が提案）:
