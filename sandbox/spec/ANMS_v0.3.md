# ANMS v0.31 — AI-Native Minimal Spec Template
...
| EARS 5パターン完備                      | When/While/If/Where + Ubiquitous。Optional Feature(Where)を含め全パターンを網羅              |
...
3. North, D. "Gherkin Language" — Cucumber Documentation (https://cucumber.io/docs/gherkin/reference/)
