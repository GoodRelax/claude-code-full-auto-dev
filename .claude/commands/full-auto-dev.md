...
1d. anms-template/anms-spec-template.md を参照し、ヒアリング結果 + user-order.md を入力にANMS形式の仕様書を docs/spec/[project-name]-spec.md に作成する（Ch1-2: Foundation・Requirements）
1e. Ch3-6 のスケルトン（見出しのみ）を同一ファイルに配置する
1f. 仕様書の概要をユーザーに報告し承認を求める
1g. review-agentで仕様書 Ch1-2 の品質レビュー（R1観点）を実施し、PASS後に次へ進む
...
14. risk-managerでリスク台帳を project-records/risks/ に作成する
