...
2. **Ambiguity-Induced Hallucination:** When instructions are given only in natural language, AI may independently infer system constraints and boundary conditions, embedding unintended behavior (bugs).
